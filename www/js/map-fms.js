...
OpenLayers.Layer.BingUK = OpenLayers.Class(OpenLayers.Layer.Bing, {
    ...
    updateAttribution: function() {
        ...
        if (z >= 16 && in_uk) {
            copyrights = 'Contains Ordnance Survey data &copy; Crown copyright and database right 2020';
        } else {
            logo = '<a href="https://www.bing.com/maps/"><img border=0 src="https://dev.virtualearth.net/Branding/logo_powered_by.png"></a>';
            copyrights = '&copy; 2020 <a href="https://www.bing.com/maps/">Microsoft</a>. &copy; AND, Navteq, Ordnance Survey';
        }
